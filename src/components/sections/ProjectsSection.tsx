      ...
      {siteConfig.projects[0] && (
        <div className="mb-8">
          <FadeIn>
            <div 
              onClick={() => {
                if (siteConfig.projects[0].liveUrl) window.open(siteConfig.projects[0].liveUrl, "_blank");
                else if (siteConfig.projects[0].githubUrl) window.open(siteConfig.projects[0].githubUrl, "_blank");
              }}
              className="group rounded-xl border border-border bg-card p-5 sm:p-6 
              ...
              {siteConfig.projects[0].showLinks && (
                <div className="flex items-center gap-4 pt-2 border-t border-border">
                  {siteConfig.projects[0].githubUrl && (
                    <a href={siteConfig.projects[0].githubUrl} target="_blank" rel="noopener noreferrer"
                      className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                      <Github size={16} />
                    </a>
                  )}
                  {siteConfig.projects[0].liveUrl && (
                    <a href={siteConfig.projects[0].liveUrl} target="_blank" rel="noopener noreferrer"
                      className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                      <ExternalLink size={16} />
                    </a>
                  )}
                  {siteConfig.projects[0].caseStudyUrl && (
                    <a href={siteConfig.projects[0].caseStudyUrl}
                      className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                      <FileText size={16} />
                    </a>
                  )}
